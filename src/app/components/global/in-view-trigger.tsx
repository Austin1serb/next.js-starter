...
type InViewTriggerProps<C extends React.ElementType> = InViewTriggerOwnProps<C> &
  Omit<React.ComponentPropsWithoutRef<C>, keyof InViewTriggerOwnProps<C>>

export function InViewTrigger<C extends React.ElementType = "div">({
  as,
  children,
  ...props
}: InViewTriggerProps<C>) {
