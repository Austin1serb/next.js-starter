...
import teslaNoTint from "./tesla-no-tint.jpg"
import tesla05 from "./tesla-05-tint.jpg"
import clsx from "clsx"

// Memoized image component
const TintImages = memo(({ opacity }: { opacity: number }) => {
  return (
    <div className="relative h-[60vw] max-h-[400px] w-full rounded-2xl border border-neutral-300 bg-white text-black lg:h-screen">
      {/* No Tint Image (base) */}
...
export const TintSimulator = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      ...
      className={`flex w-full flex-col items-center text-black ${className} [--accent-alt:oklch(0.37_0.232012_264.2049)] [--accent:oklch(0.54_0.2531_262.09)]`}
    >
      <style jsx>{`
      ...
      <p className="h4-display mt-5 uppercase">{sliderValue}% Tint</p>
