...
export const TabsSSR: React.FC<{ phases: Phase[] }> = ({ phases }) => {
          ...
          {phases.map((phase) => {
            ...
            return (
              <button
                ...
                data-ui={`set:data-phase(${phaseId})`}
                className={`group relative z-1 rounded-xl p-4 text-center transition-all duration-300 hover:cursor-pointer ${tw}`}
              >
